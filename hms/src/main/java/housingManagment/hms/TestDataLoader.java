...
public class TestDataLoader implements CommandLineRunner {
    ...
    private static final Map<SchoolsAndSpecialties, Enum<?>[]> SCHOOL_SPECIALTIES = Map.of(
            SchoolsAndSpecialties.SCHOOL_OF_ENGINEERING_AND_DIGITAL_SCIENCES,
            housingManagment.hms.enums.userEnum.schools.SchoolOfEngineeringAndDigitalSciences.values(),
            SchoolsAndSpecialties.SCHOOL_OF_MEDICINE,
            housingManagment.hms.enums.userEnum.schools.SchoolOfMedicine.values(),
            SchoolsAndSpecialties.SCHOOL_OF_SCIENCES_AND_HUMANITIES,
            housingManagment.hms.enums.userEnum.schools.SchoolOfSciencesAndHumanities.values(),
            SchoolsAndSpecialties.GRADUATE_SCHOOL_OF_PUBLIC_POLICY,
            housingManagment.hms.enums.userEnum.schools.GraduateSchoolOfPublicPolicy.values(),
            SchoolsAndSpecialties.GRADUATE_SCHOOL_OF_BUSINESS,
            housingManagment.hms.enums.userEnum.schools.GraduateSchoolOfBusiness.values(),
            SchoolsAndSpecialties.GRADUATE_SCHOOL_OF_EDUCATION,
            housingManagment.hms.enums.userEnum.schools.GraduateSchoolOfEducation.values());
