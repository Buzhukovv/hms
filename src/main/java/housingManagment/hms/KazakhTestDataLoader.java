...
/**
 * This class populates the database with Kazakh students and dormitory rooms.
 * Only active when the 'kazakh' profile is active.
 */
@Component
@RequiredArgsConstructor
@Slf4j
@Profile("kazakh")
@Order(2) // Run after the default TestDataLoader
public class KazakhTestDataLoader implements CommandLineRunner {
